...
<body class="body-wrapper">
  ...
  <br>
  <img src="{{asset('assets2/images/rumah54.jpg')}}" height="600px" width="1270px">
  <br><br>
  <center>
    <h1>DESAIN RUMAH</h1>
  </center>
  ...
  <center>
    <table>
      ...
      <tr>
        <td><img src="{{asset('assets2/images/rumah54.jpg')}}" height="500px" width="500px"></td>
        <td> &nbsp &nbsp &nbsp &nbsp</td>
        <td><img src="{{asset('assets2/images/fasadtype54.jpg')}}" height="500px" width="500px"></td>
      </tr>
    </table>
  </center>
