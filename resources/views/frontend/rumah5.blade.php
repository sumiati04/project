...
<body class="body-wrapper">
  ...
  <br>
  <img src="{{asset('assets2/images/rumah90.jpg')}}" height="600px" width="1350px">
  <br><br>
  <center>
    <h1>DESAIN RUMAH</h1>
  </center>
  ...
  <center>
    <table>
      ...
      <tr>
        <td><img src="{{asset('assets2/images/rumah90.jpg')}}" height="500px" width="500px"></td>
        <td> &nbsp &nbsp &nbsp &nbsp</td>
        <td><img src="{{asset('assets2/images/fasadtype100.jpg')}}" height="500px" width="500px"></td>
      </tr>
    </table>
  </center>
  ...
  <table>
    ...
    <tr>
      <td> &nbsp 3 Kamar tidur. 1 Kamar tidur dilantai 1, 2 kamar tidur dilantai 2. Kamar tidur utama &amp; kamar tidur untuk anak ada dilantai 2 &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp
