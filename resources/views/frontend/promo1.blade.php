...
<body class="body-wrapper">
  ...
  <div class="col-lg-12">
    <table>
      <tr>
        <td><img src="{{asset('assets2/images/rumahmasadepan.jpg')}}" height="400px" width="600px"></td>
        <td>
          <p></p>
        </td>
        <td>
          <h4>Type 90 / 100</h4>
          <ol>
            <li> Cash Keras, Free 90 gr emas atau diskon 10% </li>
            <li> Cash Bertahap DP 50%, Free 45 gr emas atau diskon 5% </li>
            <li> DP 30%, Free 22 gr emas atau diskon 2.5% </li>
            <li> DP 10% - 15%, Free 5gr emas setelah pembayaran 50jt </li>
            <li>
              <p></p>
            </li>
            <li>
              <center>
                <a href="{{url('/formpromo')}}"><button type="button" class="btn btn-outline-dark">Ambil Promo</button></a>
              </center>
            </li>
          </ol>
        </td>
    ...
    <br>
    <center>
      <h5><b><i>Segera ambil promonya sekarang juga, karena terbatas hanya di bulan Juli 2022</i></b></h5>
    </center>
  </div>
  </div>
  <br>
